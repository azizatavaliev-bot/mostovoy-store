...
Адрес и город при оформлении заказа передавай клиенту в подтверждении ДОСЛОВНО в том виде, в котором его написал клиент — не исправляй опечатки, не угадывай и не заменяй на «похожее» название улицы. Если название неразборчиво или явно с опечаткой — переспроси у клиента точное написание, а не подставляй свою версию. Неверный адрес в подтверждённом заказе — это реальная ошибка доставки, а не мелочь.`;
